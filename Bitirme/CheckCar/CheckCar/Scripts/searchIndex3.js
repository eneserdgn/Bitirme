...
app.controller('searchCtrl', function ($scope, $http) {
    ...
    $scope.searchIndex = function () {
        ...
        if (angular.isUndefinedOrNull($scope.search.yakitlar) || Â $scope.search.yakitlar == 0) {
    $scope.search.yakitlar = -1;
}
if (angular.isUndefinedOrNull($scope.search.vitesler) || Â $scope.search.vitesler == 0) {
    $scope.search.vitesler = -1;
}
if (angular.isUndefinedOrNull($scope.search.kasaTipi) || Â $scope.search.kasaTipi == 0) {//new
